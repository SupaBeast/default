<?php /* Smarty version Smarty 3.1-RC1, created on 2012-06-01 12:39:55
         compiled from "C:\Users\Supa\Desktop\garbage\www\fortumo\templates\pages\features.tpl" */ ?>
<?php /*%%SmartyHeaderCode:39174fc88deba96f98-78758610%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9cc2d0a1fc089febad97248ae81435782a4336ef' => 
    array (
      0 => 'C:\\Users\\Supa\\Desktop\\garbage\\www\\fortumo\\templates\\pages\\features.tpl',
      1 => 1336122305,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '39174fc88deba96f98-78758610',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty 3.1-RC1',
  'unifunc' => 'content_4fc88debca262',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fc88debca262')) {function content_4fc88debca262($_smarty_tpl) {?><?php if (!is_callable('smarty_function_partial')) include 'C:\Users\Supa\Desktop\garbage\www\_html-warrior\externals\smarty\libs\plugins\function.partial.php';
?>@title = "Features Page"
<div class="content">
  <div class="content-inner">
    <div class="features">
        <div class="features-img">
          <?php echo smarty_function_partial(array('class'=>"img",'tpl'=>"img",'src'=>"data/features.png",'indent'=>"          "),$_smarty_tpl);?>

          <a class="in-app" href="javascript:void(0)"><?php echo smarty_function_partial(array('tpl'=>"img",'src'=>"data/in-app.png"),$_smarty_tpl);?>
</a>
          <a class="widget" href="javascript:void(0)"><?php echo smarty_function_partial(array('tpl'=>"img",'src'=>"data/widget.png"),$_smarty_tpl);?>
</a>
        ...
        <div class="col col03">
          <div class="row01">
            <a class="caption04" href="javascript:vodi(0)">In-App Purchasing</a>
          </div>
          <div class="row02">
            <span>For Android, Java and Blackberry</span>
          </div>
          <div class="row03">
        ...
        <div class="col col03 col04">
          <div class="row01">
            <a href="javascript:vodi(0)" class="caption04">Mobile Payments for Web Apps</a>
          </div>
          <div class="row02">
            <span>For desktop, mobile web and HTML5 apps</span>
          </div>
          <div class="row03">
            <span>Seamless UI, less clicks</span>
          </div>
          <div class="row04">
            <span>Mobile operator billing in 61 countries</span>
          </div>
        ...
        <div class="col col03 col05">
          <div class="row01">
            <a href="javascript:vodi(0)" class="caption04">API for Developers</a>
          </div>
          <div class="row02">
            <span>For adding mobile operator billing to any app or service in minutes</span>
          </div>
          <div class="row03">
            <span>Support for HTTP and XML</span>
          </div>
          <div class="row04">
            <span>Premium SMS connectivity on shared shortcodes in 58 countries</span>
          </div>
          <div class="row05">
            <a class="button06" href="javascript:void(0)"><span class="button06-inner">Sign Up</span></a>
          </div>
        </div>
    </div>
    <div class="dot-line"></div>
    <h1 class="caption02">Why Fortumo?</h1>
    <div class="col col06">
      <div class="answere01">
       <?php echo smarty_function_partial(array('class'=>"img",'tpl'=>"img",'src'=>"base/answere01.png",'indent'=>"       "),$_smarty_tpl);?>

       <div class="text">
        <span class="caption03">Mobile Operator Billing</span>
        <p>No credit card required, no registration necessary. It just works. For 4 billion mobile users worldwide. </p>
       </div>
      </div>
      <div class="answere01">
       ...
       <div class="text">
        <span class="caption03">Self Service Setup, Live in Minutes</span>
        <p>One quick integration & start getting revenue from 61 countries the next day.</p>
       </div>
      </div>
    </div>
    <div class="col col07 rfloat">
      <div class="answere02">
       <?php echo smarty_function_partial(array('class'=>"img",'tpl'=>"img",'src'=>"base/answere03.png",'indent'=>"       "),$_smarty_tpl);?>

       <div class="text">
        <span class="caption03">Best Emerging Market Coverage</span>
        <p>With Fortumo, you accept payments from users without credit cards in 6 out of 7 continents. (Sorry, no Antarctica!)</p>
       </div>
      </div>
      <div class="answere02">
       ...
       <div class="text">
        <span class="caption03">No Setup Fees, No Monthly Fees</span>

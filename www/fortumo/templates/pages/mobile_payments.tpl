    ...
    <div class="mobile-widget">
      ...
      <div class="box left">
        <div class="img macbook">
          {partial tpl="img" src="data/macbook-new02.png"}
      ...
      <div class="box right">
        <div class="img">
          {partial tpl="img" src="data/android-widget-img.png"}
        </div>
        <div class="text">
      ...
      <div class="box left">
        <div class="img all-devices">
          {partial tpl="img" src="data/all-devices.png"}
        </div>
        <div class="text">
    ...
    <div class="bg-wrap">
      ...
      <div class="testimonials-small">
        <div class="group first">
          {partial class="img" tpl="img" src="data/travian.png"}
          <div class="text">
        ...
        <div class="group">
          {partial class="img" tpl="img" src="data/topeleven.png"}
          <div class="text">
        ...
        <div class="group">
          {partial class="img" tpl="img" src="data/paymentwall.png"}
          <div class="text">

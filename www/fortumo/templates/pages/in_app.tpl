...
<div class="content no-bg">
  <div class="content-inner no-padding">
    ...
    <div class="mobile-widget">
      ...
      <div class="box left">
        <div class="img">
          {partial tpl="img" src="data/in-app-first.png"}
        </div>
        <div class="text">
      ...
      <div class="box right">
        <div class="img in-app-second">
          {partial tpl="img" src="data/in-app-second.png"}
        </div>
        <div class="text">
      ...
      <div class="box left">
        <div class="img all-devices">
          {partial tpl="img" src="data/in-app-third.png"}
        </div>
        <div class="text">
    ...
    <div class="bg-wrap">
      ...
      <div class="sms-features">
        ...
        <div class="group-content">
          <div class="group-left">
            <div class="lfloat">
              {partial class="img" tpl="img" src="base/fully-localized.png"}
            </div>
            <div class="text">
        ...
        <div class="group-content">
          <div class="group-left">
            <div class="lfloat">
              {partial class="img qtip" tpl="img" src="base/offline.png"}
            </div>
            <div class="text">
          ...
          <div class="group-right">
            <div class="rfloat">
              {partial class="img" tpl="img" src="base/support.png"}
            </div>
            <div class="text">
      ...
      <div class="sms-questions-wrap">
        <div class="sms-questions">
          ...
          <div class="testimonial-content in-app">
            <div class="knowledge">
              {partial class="img" tpl="img" src="data/peter-vesterbacka.png"}
              <div class="text">
